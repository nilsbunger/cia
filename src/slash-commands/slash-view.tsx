...
import { getConfig, setBaseBranch, setBranchPrefix, setEditCommand, setOnCreateScript, setRunCommand, setRunDir } from "../config"
...
export const ConfigView: React.FC<{
  ...
  const { branchPrefix, baseBranch, runCommand, runDir, onCreateScript, editCommand, repoRoot } = state
  ...
  return (
    <ConfigPrompt
      ...
      onSubmit={async (prefix, base, cmd, dir, createScript, editCmd) => {
        ...
        const config = result.ok ? result.config : { branchPrefix, baseBranch, runCommand, runDir, onCreateScript, editCommand }
        dispatch({
          type: "loaded-config",
